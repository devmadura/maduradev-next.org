  ...
  return (
    <section className="relative w-full py-20 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-background to-red-500/10" />
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/telegram" target="_blank">
                <div className="bg-gradient-to-r from-primary to-blue-400 hover:from-primary/90 hover:to-blue-400/90 transition-all duration-300 rounded-xl hidden sm:flex">
                  <Image
              ...
              <Button
                size="lg"
                variant="outline"
                className="group relative overflow-hidden border-red-300"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-primary/10 to-red-500/10 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
